...
export interface EditorEmbedMode {
  ...
  /** EduCowork host: save document to workspace USB storage */
  onSaveToHost?: () => void | Promise<void>;
  /** EduCowork host: close editor and return to file explorer */
    ...
    <div className="app editor">
      <Toolbar
        ...
        shareDisabled={
          isEmbed
            ? false
            : !collab.isReady || !collab.isWsConnected || !collab.isSynced
        }
