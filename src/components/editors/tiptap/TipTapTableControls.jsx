...
import { equalizeTableColumns, fitAllTablesToFullWidth, fitTableToFullWidth } from '../../../lib/tiptap/tableWidthCommands.js';
import {
  IconAlignCenter,
  IconAlignLeft,
  IconAlignRight,
  IconAllTablesFullWidth,
  IconCellNext,
  IconCellPrev,
  IconColAfter,
  IconColBefore,
    ...
    <div className="tiptap-toolbar__row tiptap-toolbar__row--table">
      ...
      <ToolbarGroup>
        ...
        <ToolbarButton
          ...
          onClick={() => {
            editor.chain().focus().run();
            fitAllTablesToFullWidth(editor);
          }}
        >
          <IconAllTablesFullWidth />
        </ToolbarButton>
